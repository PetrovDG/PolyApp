...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onCircleClick(Circle circle) {
        // Flip the values of the red, green, and blue components of the circle's
        // stroke and fill color.
        int color = circle.getStrokeColor() ^ 0x00ffffff;
        circle.setStrokeColor(color);
        color = circle.getFillColor() ^ 0x00ffffff;
        circle.setFillColor(color);

        Toast.makeText(this, "Circle around " + circle.getTag().toString(), Toast.LENGTH_SHORT).show();
    }
